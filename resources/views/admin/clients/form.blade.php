...
<div class="form-group {{ $errors->has('ci') ? 'has-error' : '' }}">
    ...
    <div class="col-md-10">
        <input class="form-control" name="ci" type="text" id="ci" value="{{ old('ci', optional($client)->ci) }}" maxlength="30">
...
<div class="form-group {{ $errors->has('nit') ? 'has-error' : '' }}">
    ...
    <div class="col-md-10">
        <input class="form-control" name="nit" type="text" id="nit" value="{{ old('nit', optional($client)->nit) }}" maxlength="30">
