...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-heading clearfix">
            ...
            <div class="pull-left">
                <h4 class="mt-5 mb-5">{{ !empty($title) ? $title : 'Venta' }}</h4>
            </div>
        ...
        <div class="panel-body">
            ...
            <form method="POST" action="{{ route('sales.sale.update', $sale->id) }}" id="edit_sale_form" name="edit_sale_form" accept-charset="UTF-8" class="form-horizontal">
            {{ csrf_field() }}
